...
public final class StructureTest extends FixturedTest {
  ...
  public void testLocationObject() {
    final Location sampleLocation = Location.factory("OnFleet HQ", new Geopoint(-122.408394, 37.783657));
  ...
  public void testLocationObjectFromJSON() throws IOException {
    final String locationSample = "{\"uuid\": \"9f9b2efd-2663-4c69-90e0-006b2dd3c631\", \"label\": \"OnFleet HQ\", \"geopoint\": {\"latitude\": -122.408394, \"longitude\": 37.783657}}";
  ...
  public void testLocationObjectNPEBoth() {
    ...
    final Location sampleLocation = Location.factory("OnFleet HQ", new Geopoint(null, null));
  }

  @Test(expected=IllegalArgumentException.class)
  public void testLocationObjectNPELongitude() {
    //noinspection ConstantConditions
    final Location sampleLocation = Location.factory("OnFleet HQ", new Geopoint(null, 37.783657));
  }
